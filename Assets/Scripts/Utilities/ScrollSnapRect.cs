...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    [System.Serializable]
    public class OnPageChanged : UnityEngine.Events.UnityEvent<int> {};
    [Tooltip("Changed page event")]
    public OnPageChanged onPageChanged = new OnPageChanged();
    ...
    void OnEnable()
    {
        ...
        _container.anchoredPosition = _pagePositions[_currentPage];
    ...
    void Update()
    {
        ...
        {
            bExcute = true;
            onPageChanged.Invoke(GetNearestPage());
        }
    }
    ...
    public void SetPage(int aPageIndex)
    {
        ...
        if (aPageIndex < 0 || _pagePositions.Count < (aPageIndex + 1)) return;
